...
class IncomingCreateView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if incoming_material_serializer.is_valid():
            ...
            # Если данные о материалах некорректны, возвращаем ошибку
